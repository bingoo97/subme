...
ON DUPLICATE KEY UPDATE
  ...
  `messenger_voice_max_duration_seconds` = VALUES(`messenger_voice_max_duration_seconds`),
...
FROM (
  ...
  UNION ALL SELECT 'Jak działają instrukcje aplikacji i podpowiedzi stron?', '<p>W Settings masz osobne przełączniki dla instrukcji aplikacji oraz dla niebieskich podpowiedzi pod stronami.</p><p>Pierwszy steruje poradnikami typu Ott-Player i podobnymi, a drugi dodatkowymi opisami interfejsu oraz dużym opisem homepage.</p><p>Dzięki rozdzieleniu tych opcji możesz precyzyjnie decydować, ile treści pomocniczych ma widzieć użytkownik.</p>', 'admin', 'instrukcje aplikacji podpowiedzi stron settings', 460, 1
